...
public class OrderFrom implements Serializable{
    ...
    public boolean equals(Object o) {
        ...
        if (item_title != null ? !item_title.equals(orderFrom.item_title) :
            ...
            return false;
        return status != null ? status.equals(orderFrom.status) : orderFrom
                .status == null;
    ...
    @Override
    public int hashCode() {
        int result = tk_status != null ? tk_status.hashCode() : 0;
        ...
        result = 31 * result + (total_commission_rate != null ?
                total_commission_rate.hashCode() : 0);
