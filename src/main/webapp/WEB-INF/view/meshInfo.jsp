...
<head>
    ...
    <script src="${ctx}/static/js/jquery.min.js.js"></script>
    ...
    <script src="${ctx}/static/js/meshInfo.js"></script>
</head>
<body>
<div class="page-heading">
    <div style="float: left">
        <input type="text" id="uName" placeholder="用户名称：">
        <input type="button" value="搜索" id="button" class="btn btn-default" style="width: 80px;">
    </div>
</div>
<div class="wrapper">
    <div class="row">
